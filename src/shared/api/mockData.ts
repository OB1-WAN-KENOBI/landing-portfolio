...
export const defaultProfile: ApiProfile = {
  ...
  aboutTexts: {
    ru: [
      "Я увлеченный Frontend разработчик с более чем 5-летним опытом создания веб-приложений. Мой путь в разработке программного обеспечения начался с любопытства о том, как работают веб-сайты, и превратился в карьеру, сосредоточенную на создании значимых цифровых впечатлений.",
    ...
    en: [
      "I'm a passionate Frontend developer with over 5 years of experience building web applications. My journey in software development started with a curiosity about how websites work, and it has evolved into a career focused on creating meaningful digital experiences.",
...
// Projects and skills data are now loaded from the server API
// See: src/shared/api/http/projectsApi.ts and src/shared/api/http/skillsApi.ts
